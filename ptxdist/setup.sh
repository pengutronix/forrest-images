...
echo "overlayfs /srv/cache overlayfs defaults,lowerdir=/srv/cache-ro,upperdir=/srv/cache-overlay,workdir=/srv/cache-work,x-systemd.requires=srv-cache\x2dro.mount 0 0" | sudo tee -a /etc/fstab
